...
const About = () => {
  ...
  return (
    <section id="about" className=" myContainer flex flex-col  mt-40 mb-20 xl:mb-0 ">
      <h2 data-scroll
          data-scroll-speed={isMobile?"0":"0.1"} style={paris.style} className="text-6xl 3xl:text-8xl capitalize mx-auto">
        about us
      </h2>
      <div className="w-full relative flex flex-col gap-16 h-[128px] 3xl:h-[459px] mt-10  xl:mt-20">
        <p
          ...
          className="xsm:text-lg  3xl:text-5xl font-light capitalize text-nowrap xl:absolute xl:right-0 xl:top-0 mix-blend-difference text-mwhite z-10"
        >
          <span className="inline-block w-0 3xl:w-48 "></span>My name is Eleanna and I
        ...
        <div
          ...
          className="w-[342px] h-[211px] self-end  3xl:w-[770px] 3xl:h-[459px] relative xl:absolute xl:top-0 3xl:-top-6 xl:left-0  "
        ...
        >
          <Image
            ...
            width={1024}
            height={768}
            className="w-[342px] h-[211px]  3xl:w-[770px] 3xl:h-[459px] object-cover absolute top-0 left-0 "
          />
          <div className="w-[342px] h-[211px]  3xl:w-[770px] 3xl:h-[459px] absolute top-0 left-0 bg-black/40"></div>
        </div>
      </div>

      <div className="w-full flex flex-col gap-16 relative  mt-80 xl:mt-32 2xl:h-[459px]  3xl:mt-12">
        <p
          data-scroll
          data-scroll-speed={isMobile?"0":"0.4"}
          className="text-lg 3xl:text-5xl font-normal lg:font-light capitalize md:text-nowrap xl:absolute xl:left-0 xl:top-0 mix-blend-difference text-mwhite"
        >
        ...
        <div
          ...
          className="w-[276px] h-[368px]  3xl:w-[576px] 3xl:h-[768px] relative xl:absolute xl:top-0 md:-top-1/3 xl:right-0"
        >
          <Image
          alt="img"
            src={"/about/sky.jpg"}
