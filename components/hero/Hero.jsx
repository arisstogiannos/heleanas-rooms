...
<div className="absolute top-0 left-0">
      <div className=" flex w-full mt-20 ">
        ...
        <div className=" flex flex-col gap-4 text-4xl md:text-6xl 3xl:text-8xl text-white capitalize text-nowrap px-5 xl:px-10">
          <h2 className="text-white">welcome to</h2>
          <h2 className="ml-14 3xl:ml-28">your holiday</h2>
          <h2 className="">destination</h2>
        </div>
        <div className="w-1/3 flex flex-col justify-between xl:-translate-x-28  xl:pt-12 xl:pb-10">
          <hr className="border-t-4 w-[190%] border-t-mwhite rounded-tl-full rounded-bl-full hidden xl:inline-block" />
          <hr className="border-t-4 w-[190%] mt-20 md:mt-28 xl:mt-0 border-t-mwhite rounded-tl-full rounded-bl-full" />
        </div>
      </div>

      <p
        style={nunito.style}
        className=" md:text-2xl md:w-2/3 xl:text-3xl font-light  text-white 2xl:w-1/3 px-8 2xl:px-0 text-center mx-auto mt-56 xsm:mt-72 md:mt-[270px] lg:mt-32 xl:mt-60  3xl:mt-32 "
      >
      ...
      <div  className="mx-auto mt-20 lg:mt-10 xl:mt-32 2xl:mt-5 w-[250px] h-[82px] md:w-[300px] md:h-[82px] relative cursor-pointer ">
      <svg
          width="200"
          height="172"
          viewBox="0 0 343 172"
        ...
        <span className="text-black absolute top-2/3 md:top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-lg md:text-2xl  uppercase font-bold">
          explore
        </span>
        <svg
          className="absolute top-[90%] md:top-[95%] xl:top-[85%] left-1/2 -translate-x-1/2 -translate-y-1/2 scale-75 md:scale-90"
          width="30"
          height="17"
          viewBox="0 0 30 17"
          fill="none"
