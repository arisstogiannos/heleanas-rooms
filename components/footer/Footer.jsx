...
const Footer = () => {
  ...
  return (
    <footer className=' bg-mBrown w-full text-white max-xl:hidden'>
        <div className='myContainer flex flex-col overflow-hidden'>
            ...
            <div className='w-full border-t-2 border-b-2 border-white py-10 mt-20 flex justify-between'>
                <p className='capitalize text-8xl text-white'>a place to remember</p>
            ...
            <div className='py-10 flex justify-between items-center'>
                ...
                <ul className='flex gap-7 text-2xl capitalize'>
                    {sociallinks.map((l,i)=>(
